...
struct background
{
  ...
  // ADF: VCDM parameters // AM: new parameters needed for w(a) spline
  // double w_0_VCDM;
  // double w_a_VCDM;
  // ADF: end of new parameters

  // AM: spline parameters for w(a)
  // int N_nodes_VCDM;        /**< number of nodes in the w(a) spline */
  // double * a_nodes_VCDM;   /**< vector of scale factors for the w(a) spline */
  // double * w_nodes_VCDM;   /**< vector of w values for the w(a) spline */

  // GB: esr parameters
  int w_function_index;    // Index into function table
  double c0_esr;           // First parameter for equation of state
  double c1_esr;           // Second parameter for equation of state
  // GB end
...
extern "C" {
  ...
  /** Spline w(a) functions **/
  double w_VCDM_linear_spline(double z, 
                              double *z_nodes, 
                              double *w_nodes, 
                              int n_nodes);

  double w_VCDM_spline(double a, 
                        double *z_nodes, 
                        double *w_nodes, 
                        int n_nodes, 
                        int n_deriv);

  double integrate_w_spline_trapezoidal(double a_min, 
                                        double a_max, 
                                        int n_steps, 
                                        double *z_nodes, 
                                        double *w_nodes, 
